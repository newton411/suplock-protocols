  ...
  return (
    ...
    >
      ...
      <div className="text-center space-y-4">
        <div className="flex items-center justify-center gap-2">
          <h2 className="text-3xl sm:text-5xl font-bold neon-text tracking-tighter uppercase">
            Yield_Optimization_Vaults
          </h2>
          <InfoPopover {...protocolInfo.ptYt} />
        </div>
        <p className="text-primary/60 font-mono text-sm">
          Automated strategies for maximum capital efficiency on Supra L1.
        </p>
      </div>
      ...
      <div className="max-w-5xl mx-auto space-y-6 mb-8">
        <h3 className="text-2xl font-bold neon-text uppercase tracking-tighter text-center mb-8">
          Understanding Your Vault Options
        </h3>
          ...
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h4 className="text-lg font-bold text-primary mb-2 uppercase">
                Stable Vault (12.4% APY) - For Conservative Investors
              </h4>
              <p className="text-sm text-muted-foreground mb-4">
                <strong className="text-primary">Best for:</strong> Investors who want steady,
                predictable returns with minimal risk.
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                This vault holds SUPRA and generates yields primarily from protocol fees. It&rsquo;s
                the safest option&mdash;your principal is protected by the 10B floor that
                we&rsquo;re aggressively building.
              </p>
              <div className="p-3 bg-primary/5 border border-primary/20 rounded text-xs text-muted-foreground">
                <strong className="text-primary">Revenue Source:</strong> Protocol fees (35%
                distributed to veSUPRA holders) and base APR (12%) paid directly by the protocol to
        ...
        >
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h4 className="text-lg font-bold text-accent mb-2 uppercase">
                Delta-Neutral Vault (18.9% APY) - For Balanced Investors
              </h4>
              <p className="text-sm text-muted-foreground mb-4">
                <strong className="text-accent">Best for:</strong> Investors seeking higher returns
                with moderate complexity.
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                This strategy uses USDC (stablecoin) and hedging to capture yields while minimizing
                price volatility. It&rsquo;s &quot;delta-neutral&quot; because it doesn&rsquo;t care
                if SUPRA goes up or down&mdash;it profits from the yield farming mechanics itself.
              </p>
              <div className="p-3 bg-accent/5 border border-accent/20 rounded text-xs text-muted-foreground">
                <strong className="text-primary">Revenue Source:</strong> Combines staking rewards
                (Supra PoEL) with DeFi protocol yields and hedging gains. Higher complexity enables
                greater returns.
              </div>
            </div>
          </div>
        ...
        >
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h4 className="text-lg font-bold text-primary mb-2 uppercase">
                Liquid Staking Vault (8.2% APY) - For Stakers
              </h4>
              <p className="text-sm text-muted-foreground mb-4">
                <strong className="text-primary">Best for:</strong> ETH stakers who want to earn
                while participating in Supra.
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                Deposits stETH (liquid-staked Ethereum) and earns validator rewards while also
                earning Supra yields. You&rsquo;re essentially getting paid twice: once from
                Ethereum staking, once from SUPLOCK.
              </p>
              <div className="p-3 bg-primary/5 border border-primary/20 rounded text-xs text-muted-foreground">
                <strong className="text-primary">Revenue Source:</strong> ETH staking already yields
                approximately 4% annually. Combined with Supra yields, this equals 8.2% with
        ...
        >
          <div className="flex items-start gap-4 mb-6">
            ...
            <div className="flex-1">
              <h4 className="text-lg font-bold text-destructive mb-2 uppercase">
                LP Vacuum Strategy (42.1% APY) - For Advanced Users ⚠️
              </h4>
              <p className="text-sm text-muted-foreground mb-4">
                <strong className="text-destructive">Best for:</strong> Experienced traders who
                understand DeFi mechanics and can handle volatility.
              </p>
              <p className="text-sm text-muted-foreground mb-4">
                The highest-yield strategy uses automated market maker (AMM) strategies to capture
                trading fees and MEV gains. <strong>MEV Protected</strong> means hackers can&rsquo;t
                see what you&rsquo;re doing&mdash;only the protocol knows.
              </p>
              <div className="p-3 bg-destructive/5 border border-destructive/20 rounded text-xs text-muted-foreground">
                <strong className="text-destructive">Revenue Source:</strong> Captures multiple
                yield streams including LP fees, market-making gains, and MEV rebates. Higher
                complexity presents proportionally higher capital risk. Deploy only funds you can
                afford to lose.
              </div>
            </div>
          </div>
        ...
        <div className="matrix-card p-8 bg-primary/5 border-2 border-primary/30">
          <h4 className="text-lg font-bold text-primary mb-6 uppercase">
            How PT/YT Splitting Works (Advanced)
          </h4>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div className="p-4 bg-background/50 border border-primary/20 rounded">
              ...
              <p className="text-xs text-muted-foreground mb-3">
                Represents your initial deposit. Trade it for liquidity without losing your yield
                rights.
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
                <li className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-primary rotate-45" /> Can be sold for cash immediately
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-primary rotate-45" /> No yield after sale
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-primary rotate-45" /> Useful if you need emergency
                  liquidity
                </li>
              </ul>
            </div>
            <div className="p-4 bg-background/50 border border-primary/20 rounded">
              ...
              <p className="text-xs text-muted-foreground mb-3">
                Represents all future earnings from your deposit. Keep it to earn 100% of profits.
              </p>
              <ul className="text-xs text-muted-foreground space-y-1">
                <li className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-primary rotate-45" /> Captures all future yields
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-primary rotate-45" /> Appreciation as vault grows
                </li>
                <li className="flex items-center gap-2">
                  <div className="w-1 h-1 bg-primary rotate-45" /> Can be held or traded
                </li>
              </ul>
            </div>
          </div>
          <p className="text-xs text-muted-foreground italic border-t border-primary/20 pt-4">
            <strong>Example:</strong> You deposit 10 SUPRA. You receive PT (worth 10 SUPRA,
            tradeable) + YT (worth future yields). If yields = 2 SUPRA/year, sell PT for 10 cash
            while keeping YT to earn the 2 SUPRA yield.
          </p>
        </div>
      </div>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-bold tracking-tighter uppercase group-hover:text-primary transition-colors">
                  {v.name}
                </h3>
                <div className="flex items-center gap-2">
                  <span
                    className={`text-[8px] px-1.5 py-0.5 border uppercase font-bold ${
                      v.risk === 'Low'
                  ...
                  {(v as any).hasPrivacy && (
                    <span className="flex items-center gap-1">
                      <span className="text-[8px] px-1.5 py-0.5 border border-accent/40 text-accent/60 uppercase font-bold">
                        MEV Protected
                      </span>
      ...
      <div className="matrix-card p-8 border-accent/30 bg-accent/5">
        <div className="flex flex-col md:flex-row items-center gap-8">
          ...
          <div className="space-y-2 flex-1 text-center md:text-left">
            <h3 className="text-2xl font-bold uppercase tracking-tighter text-accent">
              Boost Your Yields Up To 2.5x
            </h3>
            <p className="text-accent/60 font-mono text-sm">
              Lock SUPRA for veSUPRA to unlock the protocol yield booster. Your locking duration
              directly impacts your vault performance.
            </p>
          </div>
