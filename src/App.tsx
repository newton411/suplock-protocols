          ...
          <Router>
            <div className="min-h-screen relative flex flex-col selection:bg-primary/30 selection:text-primary overflow-x-hidden">
                  ...
                  >
                    ...
                    <div className="w-full max-w-md space-y-4 font-mono text-xs">
                      ...
                      <div className="space-y-1 text-primary/80">
                        ...
                        >
                          &gt; Establishing secure handshake with Supra L1...
                        </motion.div>
                        <motion.div
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                        ...
                        >
                          &gt; Verifying DAO governance signatures...
                        </motion.div>
                        <motion.div
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
                        ...
                        >
                          &gt; Decrypting vault yield strategies...
                        </motion.div>
                        <motion.div
                          initial={{ opacity: 0 }}
                          animate={{ opacity: 1 }}
              ...
              <div className="bg-primary text-black text-[8px] font-bold py-1 overflow-hidden whitespace-nowrap z-[60] relative uppercase tracking-[0.2em]">
                ...
                >
                  SYSTEM_ACCESS: GRANTED | SECURITY_LEVEL: OMEGA | PROTOCOL: SUPLOCK v1.0.4 |
                  NETWORK: SUPRA_L1_MAINNET | REVENUE_DISTRIBUTION: ACTIVE | VE_LOCKING: ENABLED |
                  MEV_PROTECTION: SHIELD_ON | SYSTEM_ACCESS: GRANTED | SECURITY_LEVEL: OMEGA |
                  PROTOCOL: SUPLOCK v1.0.4 | NETWORK: SUPRA_L1_MAINNET | REVENUE_DISTRIBUTION:
                  ACTIVE | VE_LOCKING: ENABLED | MEV_PROTECTION: SHIELD_ON
                </motion.div>
              </div>
